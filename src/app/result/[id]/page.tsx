...
function ScoreRing({ score }: { score: number }) {
  const scoreColor = score <= 3.5 ? "#EF4444" : score <= 6 ? "#F59E0B" : "#22C55E";
    ...
    <div className="relative h-[180px] w-[180px]">
      ...
      <div 
        ...
        style={{
          ...
          borderRightColor: score > 3.5 ? "transparent" : scoreColor,
          borderBottomColor: score > 6 ? scoreColor : "transparent",
          borderLeftColor: score > 6 ? "transparent" : scoreColor,
...
function Badge({ label, variant }: { label: string; variant: "critical" | "warning" | "good" }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className={`font-mono text-[13px] font-medium ${textColors[variant]}`}>
        {label}
      </span>
    </div>
  );
    ...
    <div className="flex min-h-[calc(100vh-56px)] flex-col gap-10 px-20 py-10">
      <div className="flex flex-col items-center gap-12">
        ...
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <h1 className="max-w-2xl font-mono text-[20px] font-normal leading-[1.5] text-[#FAFAFA]">
          ...
          <button className="rounded border border-[#2A2A2A] px-4 py-2 font-mono text-[12px] text-[#FAFAFA] hover:bg-[#2A2A2A] transition-colors">
            $ share_roast
          </button>
        </div>
      </div>
